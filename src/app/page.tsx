      ...
      <div className="flex flex-col justify-center items-center h-screen bg-gray-100">
        <div className="bg-white p-8 rounded-lg shadow-lg w-[350px] sm:w-[400px]">
          <div className="flex justify-between">
            ...
            <a href="/auth/register" className="text-xl font-bold  mb-6 text-center">
              Register
            </a>
          </div>
          {loading ? (
                ...
                >
                  ...
                  <div className="border-2 border-dashed border-gray-300 p-4 rounded-lg">
                    <p className="mb-2">
                      ...
                      {filteredTicket.username}
                    </p>
                    <p className="mb-2">
                      <strong className="font-bold text-gray-700">
                        Email:
                      </strong>{" "}
                      {filteredTicket.email}
                    </p>
                    <p className="mb-2">
                      <strong className="font-bold text-gray-700">
                        Phone:
                    ...
                    <p className="mb-2">
                      ...
                      {filteredTicket.companyname}
                    </p>
                    <p className="mb-4">
                      <strong className="font-bold text-gray-700">
                        Job Title:
                      </strong>{" "}
                      {filteredTicket.jobtitle}
                    </p>
                  </div>
                  <button
                    onClick={downloadPDF}
